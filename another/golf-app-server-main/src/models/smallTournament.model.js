...
const smallTournamentSchema = new mongoose.Schema({
    ...
    typeName:{type:String,default:"small"},
    ...
    handicapFromRange:{type:Number,required:true},
    handicapToRange:{type:Number,required:true},
    tournamentImage: {
        type: Object,
...
smallTournamentSchema.index({ courseLocation: "2dsphere" });

const SmallTournament = mongoose.model("SmallTournament", smallTournamentSchema);

module.exports = SmallTournament;